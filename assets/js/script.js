...
$(document).ready( function()	{
	...
	d3.json("assets/data/combined.json", function(error, data) {
		...
		var earthquakes = data.objects.earthquakes;
		...
		var earthquake = g.append("g")
			...
			.attr("d", path.pointRadius( function(d) { if ( !d.properties.magnitude || d.properties.magnitude < 2.5 ) { return 1 } else { return scale(d.properties.magnitude); } } ));	
